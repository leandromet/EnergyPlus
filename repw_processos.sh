...
A simple wrapper for running processes in parallel.  
...
shift  
 ...
 do 
	...
	echo "if $INS, $EPW, $CMD"
        ...
        CMD="$COMMAND $INS $EPW" #append args  
	echo "else $INS, $EPW, $CMD"
...
echo "$# Modelos executados,
Arquivos: $@"
echo "Com no máximo $MAX_NPROC processos paralelos"
